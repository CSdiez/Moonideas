...
let DEFAULT_MAX_IMG = 7;

// animations default time (ms)
let DEFAULT_ANIMATION_TIME = 7000;
let DEFAULT_TRANSITION_TIME = 1200;

// Default Pictures Folder
let DEFAULT_IMG_FOLDER = "assets/img";

// Default Pictures Brightness (value between 0 and 1)
let DEFAULT_BRIGHTNESS = 0.3;
...
let lb_img_folder;
let lb_max_img;
let lb_animation_time;
let lb_transition_time;
let lb_brightness;
...
function livebackground(){
	...
	$("#background"+show).css("background", "url('"+lb_img_folder+"/bg-0"+current_img+".jpg') no-repeat center center");
